...
import org.example.article.ArticleMem;
...
public class ArticleMain {
    public static void main(String[] args) {
        ...
        List<ArticleMem> articles = new ArrayList<>();
        ...
        while (!quit) {
            ...
            switch (command) {
                ...
                case "2":
                    // 모든글을 순회할 것인데,
                    // 사용자가 하나 보기에서 어떤 숫자를 넎을지를 판단할 수 있게
                    // 하기 위해서, i로 같이 출력해준다.
                ...
                case "3":
                    ...
                    // 해당 글을 가져와서
                    ArticleMem article = articles.get(idx);
                    ...
                    System.out.println(String.format("내용: %s",article.getTitle()));
                    break;
                // 반복 종료하기
                case "q":
                    quit = true;
